...
private:
    ...
    //MoveConstructible.
    //  Furthermore, F must be callable with no arguments; it can, for example, be
    //  a bind object with no placeholders. F may or may not be CopyConstructible.
    template <typename F,
    ...
    public:
        ...
        // to
        //  bind an lvalue reference - it is not a guarantee that an object of type
